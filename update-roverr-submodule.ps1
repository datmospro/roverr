...
if ($changes) {
    ...
    Write-Host "✓ Cambios commiteados en roverr" -ForegroundColor Green
} else {
...
try {
    ...
    Write-Host "✓ Roverr pusheado a GitHub" -ForegroundColor Green
} catch {
    Write-Host "⚠ Ya está actualizado en GitHub o hubo un error" -ForegroundColor Yellow
}
...
Write-Host "✓ Submodule actualizado" -ForegroundColor Green
...
if ($submoduleChanges) {
    ...
    git push origin main
    Write-Host "✓ Submodule pusheado a GitHub" -ForegroundColor Green
} else {
    Write-Host "⚠ Submodule ya está actualizado" -ForegroundColor Yellow
}

Write-Host "`n=== ¡Actualización Completa! ===" -ForegroundColor Cyan
Write-Host "✓ Proceso completado" -ForegroundColor Green
Write-Host "`nHome Assistant detectará la nueva versión en breve." -ForegroundColor White
